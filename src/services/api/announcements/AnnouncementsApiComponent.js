...
const AnnouncementsApiComponent = async (
  url,
  method,
  body = null,
  ...
  try {
    ...
    if (method.toLowerCase() === 'get') {
      ...
      return handlePostResponse(response, postAnnouncements);
...
const handlePostResponse = (response, postAnnouncements) => {
...
export default AnnouncementsApiComponent;
